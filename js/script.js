...
title = document.querySelector('#greet');
...
var quote = [
    ...
    "Converting Experiments into Experience makes you professional – Quoter",
    ...
    "I’ve learned that people will forget what you said, people will forget what you did, but people will never forget how youmade them feel.” – Maya Angelou",
    ...
    "If you look at what you have in life, you’ll always have more. If you look at what you don’t have in life, you’ll neverhave enough.” – Oprah Winfrey",
    ...
    "Motivation is a fire from within. If someone else tries to light that fire under you, chances are it will burn verybriefly.” – Stephen R. Covey",
    ...
    "Anyone who stops learning is old, whether at twenty or eighty. Anyone who keeps learning stays young. The greatest thingin life is to keep your mind young.” – Henry Ford",
    ...
    "Courage doesn’t always roar. Sometimes courage is the little voice at the end of the day that says ‘I’ll try againtomorrow.'” – Mary Anne Radmacher",
    ...
    "Life is like a camera. Just focus on what’s important, capture the good times, develop from the negatives, and if thingsdon’t work out, just take another shot.” – Unknown",
...
function newQuote() {
	...
	document.getElementById('quote').innerText = quote[randomNumber];
}